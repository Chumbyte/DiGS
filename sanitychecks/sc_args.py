...
def add_args(parser):
    ...
    parser.add_argument('--model_name', type=str, default='SINR_model', help='trained model name')
    ...
    parser.add_argument('--pt_circle_path', type=str, default='/mnt/IronWolf/logs/DiBS/2D/grid_sampling_256/circle/siren/trained_models/line2d_model_model_9900.pth',
                        help='path to pretrained circle model')
